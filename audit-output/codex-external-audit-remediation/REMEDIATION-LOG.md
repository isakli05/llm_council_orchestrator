...
> | PROD-003 | **FIXED (deterministik) + ACCEPTED-DOC (canlı iddia)** | MENTIONS_TERMS → CONSTRAINT_TRACE (köklendirme zinciri + sayısal ilişki + yasak-icat; 9 adversarial vaka); korpus+eşik+rubrik-dosya-baytları sha256 kilidi `0024fef9…` (geçmiş zincirli, append-only); ön-kayıtlı signTest() kriteri kodda; sahip-yetkili 3-tekrarlı canlı koşum İCRA EDİLDİ (2026-08-30): ölçüt 1-5 MET (%100 bloklama 48/48, 0 yasak-icat, tam usage, maliyet 2.04×) ama bağlayıcı signTest NOT MET (9 ayrışık < 10; p=0.0195) → konsey-üstürlük iddiası EMEKLİ; konsey DENEYSEL, tek ajan varsayılan; kanıt: audit-output/eval/LIVE-EVAL-RESULT-2026-08-30.md |
